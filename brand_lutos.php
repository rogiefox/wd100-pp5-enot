...
<body>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Lotus_banner1.jpg" class="d-block w-100" alt="..." height="600">
            </div>
            <div class="carousel-item">
                <img src="img/Lotus_banner2.jpg" class="d-block w-100" alt="..." height="600">
            </div>
            <div class="carousel-item">
                <img src="img/Lotus_banner3.jpg" class="d-block w-100" alt="..." height="600">
            </div>
        </div>
    ...
    <?php
        ...
        $selectProductStmt = "SELECT * FROM `product_tbl` WHERE Product_Brands = 'Lotus'";
